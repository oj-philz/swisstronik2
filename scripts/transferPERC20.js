...
async function main() {
    const contractAddress = "0xa9b04108E0dA2C19a71a1BA5a9804d0bCaF23913"
    const [signer] = await hre.ethers.getSigners();
    const contract = await hre.ethers.getContractAt("PERC20Token", contractAddress, signer);
  ...
  console.log(`Transaction URL of Transfer: https://explorer-evm.testnet.swisstronik.com/tx/${transaction.hash}`);
}
